...
SHA-256: `e0ccc95b4e7c5290df6284c8b0b989898393229427a7e60126772d6afca813da`.
Tested source: **a348a96cc5aee9d797739de9c3d13045ac8c1c86**. [Clean Linux CI passed](https://github.com/AndSuch-Mods/General-AI-Test-Space-2/actions/runs/35526877697); [download the build bundle](https://github.com/AndSuch-Mods/General-AI-Test-Space-2/actions/runs/35526877697/artifacts/10609772015). The bundle was downloaded and inspected: all 25 tests passed with zero skips, and the production JAR is byte-identical to Windows. An initial comparison exposed CRLF versus LF in the mixin JSON only; normalizing it resolved the mismatch. The final handoff commit retains the existing Git LF policy, marks PNGs as binary, and records this evidence with [skip ci]; no Java source or build-logic change after the tested commit. See `validation/local-validation.json` and `validation/ci-validation.json`.
